...
<head>
    ...
    <!-- Clockpicker -->
    <link href="<?php echo e(asset('assets/vendor/clockpicker/css/bootstrap-clockpicker.min.css')); ?>" rel="stylesheet">
    <!-- asColorpicker -->
    <link href="<?php echo e(asset('assets/vendor/jquery-asColorPicker/css/asColorPicker.min.css')); ?>" rel="stylesheet">
    <!-- Material color picker -->
    <link
        href="<?php echo e(asset('assets/vendor/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css')); ?>"
        rel="stylesheet">
 ...
 <div id="preloader">
  <div class="lds-ripple">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="dashboard" class="brand-logo">
                <img alt="image" width="50" src="<?php echo e(asset('assets/images/logo.png')); ?>">
                <div class="brand-title">
                    <h2 class="">PMB UBHI</h2>
                </div>
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                            <li class="nav-item d-flex align-items-center">
                                <?php
                                    ...
                                    //$date = date('l, Y-m-d ');
                                ?>
                                <strong><?php echo e($date); ?> &nbsp;
                                    <span id="jamServer">
                                        <?php
                                            date_default_timezone_set('Asia/Jakarta');
                                            $datenow = date('H:i:s');
                                        ?>
                                        <h6> <strong> <?php echo e($datenow); ?></strong></h6>
                                    </span>
                                </strong>
                                ...
                                <a class="nav-link" href="javascript:void(0);" role="button"
                                    ...
                                    <?php if(auth()->user()->profile->foto != null): ?>
                                        <img class="avatar-lg rounded-circle img-thumbnail"
                                            src="<?php echo e(url('/' . auth()->user()->profile->foto)); ?>" alt=""
                                            width="50px" />
                                    <?php else: ?>
                                        <img class="avatar-lg rounded-circle img-thumbnail"
                                            src="<?php echo e(asset('assets/images/avatar/user-default.png')); ?>" alt=""
                                            width="50px" />
                                    <?php endif; ?>
                                </a>
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <form method="POST" action="<?php echo e(route('logout')); ?>"
                                        ...
                                        <button type="submit"
                                            ...
                                            <span class="ms-2"><?php echo e(__('Logout')); ?></span>
                                        </button>
                                    </form>
                                </div>
                            </li>
        ...
        ***********************************-->
        ...
        <div class="dlabnav">
            ...
            <div class="dlabnav-scroll">
                ...
                <div class="side-bar-profile">
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        ...
                        <div class="profile-info1">
                            <h4 class="fs-18 font-w500"><?php echo e(auth()->user()->name); ?></h4>
                ...
                <div class="copyright">
                    <p><strong>assets UBHI </strong> ©
                        <script>
                            document.write(new Date().getFullYear())
                        </script> All Rights Reserved
                    </p>
                    <p class="fs-12">Made with <span class="heart"></span> by Seftina Aulia</p>
                </div>
            </div>
        </div>
        <!--**********************************
        ...
        <div class="footer">
            <div class="copyright">
                <p>Copyright ©
                    ...
                    Designed &amp; Developed by <a href="https://www.instagram.com/seftinaulia/"
                        target="_blank">Seftina Aulia</a>
                </p>
            </div>
        </div>
        <!--**********************************
    ...
    ***********************************-->
    ...
    <!-- clockpicker -->
    <script src="<?php echo e(asset('assets/vendor/clockpicker/js/bootstrap-clockpicker.min.js')); ?>"></script>
    <!-- asColorPicker -->
    <script src="<?php echo e(asset('assets/vendor/jquery-asColor/jquery-asColor.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/jquery-asGradient/jquery-asGradient.min.js')); ?>"></script>
    <script src="<?php echo e(asset('assets/vendor/jquery-asColorPicker/js/jquery-asColorPicker.min.js')); ?>"></script>
    <!-- Material color picker -->
    <script src="<?php echo e(asset('assets/vendor/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js')); ?>">
    </script>
    <!-- pickdate -->
    ...
    <!-- Clockpicker init -->
    <script src="<?php echo e(asset('assets/js/plugins-init/clock-picker-init.js')); ?>"></script>
    <!-- asColorPicker init -->
    <script src="<?php echo e(asset('assets/js/plugins-init/jquery-asColorPicker.init.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('assets/js/plugins-init/sweetalert.init.js')); ?>"></script>

    <!-- Toastr -->
    <script src="<?php echo e(asset('assets/vendor/toastr/js/toastr.min.js')); ?>"></script>

    <!-- All init script -->
    <script src="<?php echo e(asset('assets/js/plugins-init/toastr-init.js')); ?>"></script>
...
<?php /**PATH /var/www/app/resources/views/master/master-admin.blade.php ENDPATH**/ ?>
            ...
            <?php if(auth()->user()->role == 'Administrator'): ?>
                <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">
                    ...
                    <ul aria-expanded="false">
                        ...
                        <li><a href="<?php echo e(route('data-sekolah')); ?>">Universitas</a></li>
                                        ...
                                        <td>
                                            <?php if($x->profile->foto != null): ?>
                                                <img class=" rounded-circle img-thumbnail"
                                                    src="<?php echo e(url('/' . $x->profile->foto)); ?>" alt=""
                                                    width="45px" />
                                            <?php else: ?>
                                                <img class="rounded-circle img-thumbnail"
                                                    src="<?php echo e(asset('assets/images/avatar/user-default.png')); ?>"
                                                    alt="" width="45px" />
                                            <?php endif; ?>
                                        </td>
...
<?php echo $__env->make('master.master-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/app/resources/views/user/data-user-admin.blade.php ENDPATH**/ ?>
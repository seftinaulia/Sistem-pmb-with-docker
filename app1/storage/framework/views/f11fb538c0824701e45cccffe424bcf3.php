                            ...
                            <td>
                                <div class="d-flex">
                                    ...
                                    <a class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"
                                            data-bs-toggle="modal" data-bs-target=".delete<?php echo e($x->id_pendaftaran); ?>"></i></a>
                                    <div class="modal fade delete<?php echo e($x->id_pendaftaran); ?>" tabindex="-1" role="dialog"
                                        aria-hidden="true">
                                            ...
                                            <div class="row align-items-center">
                                                ...
                                                <div class="col-xl-3  col-lg-6 col-sm-6 mb-sm-4 mb-0">
                                                    <div class="d-flex project-image">
                                                        ...
                                                        <div>
                                                            <small class="d-block fs-16 font-w400"><?php echo e($x->gelombang); ?></small>
...
<?php echo $__env->make('master.master-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/app/resources/views/pendaftaran/data-pendaftaran-admin.blade.php ENDPATH**/ ?>
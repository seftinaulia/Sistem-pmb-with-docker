                                    ...
                                    <form action="save-school" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" list="datalistOptionsSekolah" id="exampleDataList"
                                                placeholder="Pilih wilayah" name="kota" value="<?php echo e(old('kota')); ?>">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="update-school/<?php echo e($x->NPSN); ?>" method="POST"
                                                            ...
                                                            <div class="row">
                                                                <div class="col-xl-4">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        id="nama" value="<?php echo e($x->NPSN); ?>"
                                                                        placeholder="Enter ID NPSN" name="id"
                                                                        readonly>
                                                                </div>
                                                                <div class="col-xl-8">
                                                                    <label for="iduser">Nama Sekolah</label>
                                                                    <input type="text" class="form-control"
                                                                        id="nama" value="<?php echo e($x->nama_sekolah); ?>"
                                                        ...
                                                        <div class="form-group">
                                                            <label for="iduser">Alamat</label>
                                                            <textarea name="Address" id="" cols="30" rows="5" class="form-control"><?php echo e($x->alamat); ?></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="iduser">Kabupaten/Kota</label>
                                                            <input class="form-control" list="datalistOptionsSekolah"
                                                                id="exampleDataList" name="kota"
                                                                value="<?php echo e($x->kota); ?>">
                                                            <datalist id="datalistOptionsSekolah">
                                                                <option value="Purwakarta">Purwakarta</option>
                                                                <option value="Subang">Subang</option>
                                                                <option value="Karawang">Karawang</option>
...
<?php echo $__env->make('master.master-admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/app/resources/views/sekolah/data-school-admin.blade.php ENDPATH**/ ?>
                ...
                <div id="carouselExampleIndicators2" class="carousel slide" data-bs-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img class="d-block w-100" src="{{ asset('assets/images/banner-1.jpg') }}"
                                alt="First slide">
                        </div>
                        <div class="carousel-item">
                            <img class="d-block w-100" src="{{ asset('assets/images/banner-2.jpg') }}"
                                alt="Second slide">
                        </div>
                    </div>
                    ...
                    <div class="new-arrivals-img-contnent">
                        ...
                        <div class="carousel-caption d-none d-md-block">
                            <a href="ecom-product-detail.html">
                                <h4 style="color: whitesmoke">{{ $x->nama_prodi }}</h4>
                            </a>
                            <p>{{ $x->jenjang_prodi }}</p>
                        </div>
                    </div>
                            ...
                            <div class="col-xl-3 col-lg-6  col-md-6 col-xxl-5 ">
                                ...
                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade show active" id="first">
                                        <img class="img-fluid" src="{{ asset('assets/images/brosur1.jpeg') }}"
                                            alt="">
                                    </div>
                                    <div role="tabpanel" class="tab-pane fade" id="second">
                                        <img class="img-fluid" src="{{ asset('assets/images/brosur2.jpeg') }}"
                                            alt="">
                                    </div>
                                </div>
                                    ...
                                    <ul class="nav slide-item-list mt-3" role="tablist">
                                        ...
                                        <li role="presentation">
                                            <a href="#second" role="tab" data-bs-toggle="tab"><img
                                                    class="img-fluid" src="{{ asset('assets/images/brosur2.jp3g') }}"
                                                    alt="" width="50"></a>
                                        </li>
                                    </ul>
                                </div>

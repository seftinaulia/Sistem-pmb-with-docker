...
<head>
    ...
    <link href="{{ asset('assets/vendor/login/style.css') }}" rel="stylesheet">
    ...
    <div class="container">
        ...
        <div class="panels-container">
            <div class="panel left-panel">
                ...
                <img src="{{ asset('assets/images/login_page.svg') }}" class="image" alt="" />
            </div>
            <div class="panel right-panel">
                ...
                <img src="{{ asset('assets/images/register.jpg') }}" class="image" alt="" />
            </div>
        </div>
    </div>
    <!--<script src="{{ asset('assets/vendor/global/global.min.js') }}"></script>
    <script src="{{ asset('assets/vendor/login/appjs') }}"></script>
    <script src="{{ asset('assets/js/custom.min.js') }}"></script>
    <script src="{{ asset('assets/js/dlabnav-init.js') }}"></script>-->
    <script src="{{ asset('assets/js/styleSwitcher.js') }}"></script>
    <script src="{{ asset('assets/vendor/login/app.js') }}"></script>
</body>

                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <select class="form-control wide" name="agama"
                                                value="{{ old('agama') }}">
                                                <option value="{{ $viewData->agama }}" selected>
                                                    {{ $viewData->agama }}
                                                </option>
                            ...
                            <div class="p-4 border-top">
                                <div class="mb-4">
                                    ...
                                    <select class="form-control wide" name="gelombang">
                                        <option value="{{ $viewData->gelombang }}" selected>
                                            {{ $viewData->jadwal->nama_kegiatan }}</option>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input class="form-control" value="{{ $viewData->pil1 }}"
                                                ...
                                                placeholder="Cari Program Studi..." name="pil1"
                                                value="{{ old('pil1') }}" autocomplete='off'>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3 mb-4">
                                            ...
                                            <input class="form-control" value="{{ $viewData->pil2 }}"
                                                list="datalistOptionsProdi" id="exampleDataList"
                                                placeholder="Type to search..." name="pil2"
                                                value="{{ old('pil2') }}" autocomplete='off'>
                                            <datalist id="datalistOptionsProdi">
                                                @foreach ($viewProdi as $z)
                                                    <option value="{{ $z->id_prodi }}">{{ $z->nama_prodi }}</option>
                                                @endforeach

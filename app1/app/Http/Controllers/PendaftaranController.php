    ...
    public function updatependaftaran(Request $a, $id_pendaftaran)
    {
        try {
            $message = [
                ...
                'nama.required' => 'Name must be filled',
                'jk.required' => 'Gender must be filled',
                'foto.mimes' => 'Photo must be in jpg, png, jpeg, gif, svg format',
                'foto.max' => 'Photo size must be less than 2MB',
                'tempatlahir.required' => 'Birthplace must be filled',
                'tanggallahir.required' => 'Date of birth must be filled',
                'agama.required' => 'Religion must be filled',
                'alamat.required' => 'Address must be filled',
                ...
                'ftberkas_ortu.mimes' => 'Parent Files must be in pdf format',
                'ftberkas_ortu.max' => 'Parent Files size must be less than 2MB',
                'sekolah.required' => 'School name must be filled',
                'smt1.required' => 'Semester 1 must be filled',
                'smt2.required' => 'Semester 2 must be filled',
                'smt3.required' => 'Semester 3 must be filled',
                'smt4.required' => 'Semester 4 must be filled',
                'smt5.required' => 'Semester 5 must be filled',
                'ftberkas_siswa.mimes' => 'Student Files must be in pdf format',
                'ftberkas_siswa.max' => 'Student Files size must be less than 2MB',
            ];
            ...
            $cekValidasi = $a->validate([
                ...
                'penghasilan_ayah' => 'required',
                'penghasilan_ibu' => 'required',
                'ftberkas_ortu' => 'mimes:pdf|max:2048',
                'sekolah' => 'required',
                'smt1' => 'required',
                'smt2' => 'required',
                'smt3' => 'required',
                'smt4' => 'required',
                'smt5' => 'required',
                'ftberkas_siswa' => 'mimes:pdf|max:2048'
            ], $message);

            $kodependaftaran = Pendaftaran::id();
            $pendaftaranLama = Pendaftaran::where("id_pendaftaran", $id_pendaftaran)->first();
            ...
            if (file_exists($file)) {
                ...
                $pathFoto = $pendaftaranLama->pas_foto;
            }
            ...
            if (file_exists($fileftberkas_ortu)) {
                ...
                $pathOrtu = $pendaftaranLama->berkas_ortu;
            }
            ...
            if (file_exists($fileftberkas_siswa)) {
                ...
                $pathSiswa = $pendaftaranLama->berkas_siswa;
            }
            ...
            if (file_exists($fileftprestasi)) {
                ...
                $pathPrestasi = $pendaftaranLama->prestasi;
            }
